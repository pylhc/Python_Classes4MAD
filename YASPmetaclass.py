...
class YASPtwiss:
#########################
    "Read orbit data from YASP output in the same way as metaclass. For SPS use YASPmetaclassSPS, this will work only for LHC"
    def __init__(self, filename, dictionary={}): 
        ...
        self.exciter=fspl[1]+"."+fspl[2]+"."+fspl[3]
        self.plane=fspl[4]
        self.beam=fspl[3]
        if "minus" in fspl[5]:
          self.str=-1.0
          ...
          print "YASP Filename not standard: ", fspl, ", exit"
          sys.exit()
