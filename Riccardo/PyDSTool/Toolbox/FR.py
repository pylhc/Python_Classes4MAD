...
from numarray import array, Float, alltrue, arange, sign
import math
...
def v_abs(a):
    """Modulus of 2D array"""
    return math.sqrt(float(a[0]*a[0]+a[1]*a[1]))
...
#                        print "Trying again..."
            ...
            if od[vname] > 2:
                ...
                for e in E[vname]:
                    ...
                    try:
                        ...
                        sgnD = float(sign(D[1]))  # get weird errors from this sometimes
                        if sgnD > 0:
        ...
        for v in V.itervalues():
            if v in fixedverts:
                continue
            v.pos = v.pos + (v.disp/v_abs(v.disp)) * min([v_abs(v.disp), t])
