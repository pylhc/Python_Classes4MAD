...
a Model object that uses a Radau integrator).
...
if __name__=='__main__':
    ...
    HH_term.makeLib(include=['malloc.h','limits.h'])
    ...
    trajdata = HHtraj_term.sample(dt=1.0, eventdata=HH_term.getEventTimes())
