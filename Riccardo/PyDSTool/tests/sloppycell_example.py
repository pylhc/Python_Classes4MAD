...
#sModel.showGenDef('cplx_eg', 'auxspec')
...
# Event3: v['SPN_53']-1
evs=sModel.generators['cplx_eg'].eventstruct.events
...
def doPlots(trajname='test', varlist=None, dt=0.1, tlo=None, thi=None):
    plotdata = sModel.sample(trajname, varlist=varlist, dt=dt, tlo=tlo, thi=thi)
    f=pylab.figure()
    for v in varlist:
