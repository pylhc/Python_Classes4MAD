...
cycle=transpose(importPointset('lor.dat'))
...
X = PyCont.plot.fig1.axes2.axes.get_position()
PyCont.plot.fig1.axes2.axes.set_position((X[0]*1.05, X[1], X[2], X[3]))
 
PyCont.plot.refresh()

#pt = PyCont['LC1'].getSpecialPoint('RG1')
#(J, maps, evec1) = getMaps(pt, 'RG', output=False, screen=True)
