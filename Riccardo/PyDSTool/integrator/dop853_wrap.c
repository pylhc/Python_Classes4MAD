...
/*-----------------------------------------------
              @(target):= _dop853.so
  ------------------------------------------------*/
#define SWIG_init    init_dop853

#define SWIG_name    "_dop853"
...
PyObject *Integrate(double *,double,double,double,double,double,double,double,int,int,int,int,int,double *);
...
static PyObject *_wrap_Integrate(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,(char *)"OOOOOOOOOOOOOO:Integrate",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6,&obj7,&obj8,&obj9,&obj10,&obj11,&obj12,&obj13)) goto fail;
    {
        int i, n;
