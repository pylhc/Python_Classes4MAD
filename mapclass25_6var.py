...
#########################
    ...
    def __init__(self, order=10, filename='fort.18'): 
        ...
        print "Initialized map with # of coefficients in x,px,y,py:",len(self.x), len(self.px), len(self.y), len(self.py), len(self.s)
...
#                            elist=[sxt,coeff1[1], coeff1[2],coeff1[3],coeff1[4], coeff1[5],coeff1[6],'&', coeff2[1], coeff2[2],coeff2[3],coeff2[4], coeff2[5],coeff2[6]]
                            elist=[sxt,str(coeff1[1])+str(coeff1[2])+str(coeff1[3])+str(coeff1[4])+str(coeff1[5])+str(coeff1[6])+'_&_'+str(coeff2[1])+str(coeff2[2])+str(coeff2[3])+str(coeff2[4])+str(coeff2[5])+str(coeff2[6])]
