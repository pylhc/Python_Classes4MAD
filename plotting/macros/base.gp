...
plot \
   ...
   "< awk '$6<20{print }' %(dir2)s/get%(data2_p1)s.out" u %(xfunc)s:%(yfunc)s:%(errfunc)s  t "%(title2)s" w e pt 7 lw 2 ps 0.8 lt 3
...
plot  \
    ...
    "< awk '$6<20{print }' %(dir2)s/get%(data2_p2)s.out" u %(xfunc)s:%(yfunc2)s:%(errfunc2)s w e pt 7 lw 2 ps 0.8 lt 3
